...
windows_smbv1 = attribute('windows_smbv1', default: true, description: 'Should we check that SMBv1 is disabled')
windows_smbv1feature = attribute('windows_smbv1feature', default: true, description: 'Should we check that SMBv1 feature is removed')
...
if windows_smbv1
  ...
  control 'smb-101' do
    ...
    desc 'Ensure SMBv1 is disabled both as feature and through registry'
